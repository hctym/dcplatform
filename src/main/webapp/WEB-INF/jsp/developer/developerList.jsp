    ...
    <div class="x-body">
      <div class="layui-row">
        <form class="layui-form layui-col-md12 x-so">
          <input class="layui-input" name="page" id="page" type="hidden" value="1">
          <input class="layui-input" name="pageSize" id="pageSize" type="hidden" value="10">
...
<!-- 		            </td> -->
		            ...
		            <td class="td-status">
		               ...
		               <c:if test="${developer.status != 1 }">
		                   <span class="layui-btn layui-btn-normal layui-btn-mini">已禁用</span></td>
		               </c:if>
		            <td class="td-manage">
